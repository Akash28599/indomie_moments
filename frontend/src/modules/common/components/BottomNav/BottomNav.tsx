...
const BottomNav = () => {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-gray-100 shadow-[0_-4px_20px_rgba(0,0,0,0.06)] h-20">
      <div className="flex items-center justify-around h-full px-10 max-w-lg mx-auto">
        ...
        >
          <div className={`w-14 h-14 rounded-full flex items-center justify-center text-white shadow-lg transition-all active:scale-90 ${
