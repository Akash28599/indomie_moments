...
export const ResetPassword = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(e?.data?.message ?? 'Reset failed. The link may have expired.');
    }
  };
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#E2231A] via-[#c41e16] to-[#E2231A] flex items-center justify-center px-4 py-12 relative overflow-hidden">
      ...
      <div className="max-w-md w-full relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-white/80">Enter and confirm your new password</p>
        </div>
                ...
                <div className="mb-5">
                  ...
                  <div className="relative">
                    <input
                      ...
                      required
                      className="w-full px-4 py-3 pl-11 rounded-lg border-2 border-gray-300 focus:border-[#E2231A] focus:outline-none transition-colors"
